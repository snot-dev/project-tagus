...
var requiredFields = lib.models(Page).getRequiredFields();
...
describe('Pages', function(){
    it("Should list all pages on /api/pages GET", function(done) {
        chai.request(server)
        .get('/api/pages/')
        .end(function(err, res) {
            ...
            res.body.forEach(function(page) {
                lib.tests.testRequiredFields(page, requiredFields);
            });
            done();
        });
    });
