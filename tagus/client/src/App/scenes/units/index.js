    ...
    render() {
        return (
            <section id="units" className="full-height col-xs-12">
                <UnitList name={this.props.name} url={this.props.match.url} list={this.props.units.list} fetchingList={this.props.units.fetchingList} savingDetail={this.props.savingDetail} content={this.props.units.content} />
